...
#        rmse, mse, norm_mse = do_evaluation(sess,outputs,images_placeholder, targets_placeholder, dataset, batch_size, intrinsic_matrix, True)
	for step in xrange(steps_per_epoch):
		feed_dict = fill_feed_dict(dataset, images_placeholder, targets_placeholder, feed_with_batch=True, batch_size=batch_size, shuffle=False, standardize_targets=standardize_targets)
		prediction_batch, target_batch = sess.run([outputs, targets_placeholder], feed_dict=feed_dict)
		batch_relative_poses_pred, batch_relative_poses_target = get_trajectories(dataset, batch_size, inverse_intrinsic_matrix, prediction_batch, target_batch, standardize_targets)
...
def get_trajectories(dataset, batch_size, inverse_intrinsic_matrix, prediction_batch, target_batch, standardize_targets):
